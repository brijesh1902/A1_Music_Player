...
public class ArtistRepo {
    ...
    public ArtistRepo(Application application) {
        context = application;
    }

    @SuppressLint("Range")
    public LiveData<List<Songs>> getArtistSongs(String k) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                Uri uriImage = ContentUris.withAppendedId(Common.art_Uri, Long.parseLong(id));
